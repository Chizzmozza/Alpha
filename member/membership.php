...
">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center">
                              <img src="../pictures/alpha-logo.jpg" alt="Logo" style="width: 60px; height: 60px; border-radius: 50%; ">
                              <h4 class="text-info fw-bold" style="font-size: 35px;"> Alpha Grind Lab</h4>
                          </div>
                          <h5 class="text-info fw-bold"style="font-size: 35px;">VIP Member</h5>
                      </div>
                      <div class="mt-4"><br><br>
                          <h3 class="fw-bold" style="margin-left: 50px;font-size: 50px;"><?php echo $fetch['points'] . " "; ?>POINTS</h3>
                      </div><br><br><br>
                      <div class="mt-2">
                          <h5 class="fw-bold"style="font-size: 40px;"><?php echo $fetch['Fname'] . " " . $fetch['Lname']; ?></h5>
                      </div>
                      <div class="mt-4">
