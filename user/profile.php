            ...
            <div class="header-content">
                <div class="header-text">
                  <h1>Welcome, <?php echo $fetch['Fname'] . " " . $fetch['Lname']; ?></h1>
                    ...
                    <button id="editProfileBtn">Edit Profile</button> <button  id="schedules">Schedules</button>
                </div>
                        ...
                        <div class="form-container">
                            <div class="left-side">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email" name="email"  value="<?php echo $fetch['email']; ?>" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="address">Address</label>
                                    <input type="text" id="address" name="address"  value="<?php echo $fetch['address']; ?>" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="profile_picture">Profile Picture</label>
                                    <input type="file" id="profile_picture" name="profile_picture" accept="image/jpg, image/jpeg, image/png">
                                </div>
                            </div>
                            <div class="right-side">
                              <div class="form-group">
                                  <label for="contact">contact</label>
                                  <input type="text" id="contact" name="contact"  value="<?php echo $fetch['contact']; ?>" disabled>
                              </div>
                                <div class="form-group">
