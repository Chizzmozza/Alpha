...
<head>
    ...
    ></script>
    <script src="https://www.paypal.com/sdk/js?client-id=AX_USvi6E079i7lb6gbFnx872LUcrNZZ4gws-57mhU17HDBe-VMJv2wvwxpBB1Bqp32XOA3H3pRcBzLw"></script>
          ...
          <div class="row align-items-center">
              ...
              <div class="col-lg-5 col-md-6">
                  <div class="landing-text">
                    ...
                    <button class="btn btn-primary rounded-pill px-4" data-bs-toggle="modal" data-bs-target="#registerModal">Become a Member!</button>
                  </div>
              </div>
              <!-- Image on the right -->
...
<div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="registerModalLabel">Choose Your Membership</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
